            ...
            <div className="bg-white dark:bg-[#141414] border border-zinc-200 dark:border-zinc-800 rounded-3xl overflow-hidden p-1">
                ...
                <div className="relative h-80 bg-zinc-100 dark:bg-zinc-900 rounded-2xl overflow-hidden inset-ring-1 inset-ring-zinc-800">
                    ...
                    <div className="absolute left-[20%] top-[80%] -translate-x-1/2 -translate-y-1/2 flex flex-col items-center">
                        ...
                        <span className="text-[10px] text-zinc-500 font-bold uppercase mt-1 bg-zinc-100/50 dark:bg-zinc-900/50 px-2 py-0.5 rounded">Lagos Hub</span>
                    </div>
                    ...
                    <div className="absolute left-[80%] top-[20%] -translate-x-1/2 -translate-y-1/2 flex flex-col items-center">
                        <div className={`w-4 h-4 rounded-full border-2 border-zinc-200 dark:border-zinc-900 z-10 ${userLocation ? 'bg-emerald-500 animate-pulse' : 'bg-zinc-700'}`} />
                        <span className="text-[10px] text-zinc-500 font-bold uppercase mt-1 bg-zinc-100/50 dark:bg-zinc-900/50 px-2 py-0.5 rounded text-center">
                ...
                <div className="p-8">
                    <div className="flex justify-between items-center mb-8">
                        ...
                        <div className="text-right">
                            <div className="text-xl font-black text-amber-500">In Transit</div>
                            <p className="text-sm text-zinc-500">Estimated delivery: Today, 4:00 PM</p>
                        </div>
                    </div>
                    ...
                    <div className="relative border-l border-zinc-200 dark:border-zinc-800 ml-4 space-y-8 pb-4">
                        ...
                        <div className="relative pl-8">
                            <div className="absolute w-4 h-4 rounded-full bg-amber-500 -left-2 top-1 shadow-[0_0_10px_rgba(245,158,11,0.5)] flex items-center justify-center">
                        ...
                        <div className="relative pl-8 opacity-40">
                            <div className="absolute w-4 h-4 rounded-full bg-zinc-200 dark:bg-zinc-800 -left-2 top-1 border-2 border-zinc-300 dark:border-zinc-700" />
                            <h4 className="font-bold text-zinc-800 dark:text-zinc-200">Out for Delivery</h4>
                            <p className="text-sm text-zinc-500">Courier will call before arrival</p>
                        </div>
                    </div>
                </div>
            </div>
